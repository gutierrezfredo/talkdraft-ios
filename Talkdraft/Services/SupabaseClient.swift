...
enum AppConfig {
    ...
    static let privacyPolicyURL = URL(string: "https://talkdraft.app/privacy")!
    static let termsOfUseURL = URL(string: "https://talkdraft.app/terms")!
    static let supportURL = URL(string: "https://talkdraft.app/support")!
